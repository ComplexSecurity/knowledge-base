Burp Suite is a [proxy](../terms/proxy.md) program that enables us to track, examine, and alter requests made by our browsers before they are forwarded to a distant server.

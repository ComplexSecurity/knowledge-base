The DNS ‘text’ (TXT) record lets a domain administrator enter text into the [Domain Name System (DNS)](dns.md). The TXT record was originally intended as a place for human-readable notes. 

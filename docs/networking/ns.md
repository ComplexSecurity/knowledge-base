NS stands for ‘nameserver,’ and the nameserver record indicates which [DNS](../networking/dns.md) server is authoritative for that domain (i.e. which server contains the actual DNS records).

...
Command-line utility on macOS that provides detailed real-time reports on power usage and system performance metrics.
...
Change the "-i" parameter to adjust the interval.

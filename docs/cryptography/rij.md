Rijndael is a symmetric key encryption algorithm that was selected as the [Advanced Encryption Standard (AES)](../cryptography/aes.md) by the U.S. National Institute of Standards and Technology (NIST) in 2001.

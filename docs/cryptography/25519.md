Curve25519 is a state-of-the-art elliptic curve offering high security and great performance, particularly designed for use in [elliptic curve cryptography (ECC)](../cryptography/ecc.md).

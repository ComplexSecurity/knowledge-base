The Post Office Protocol (POP) is an Internet standard protocol used by local email software clients to retrieve emails from a remote mail server over a [TCP/IP](../networking/tcpip.md) connection. 

**FTP (File Transfer Protocol)** is a standard network protocol used for the transfer of files from one host to another over a [TCP](../networking/tcp.md)-based network, such as the Internet.

...
Combines the functionality of the traceroute and ping programs to provide a real-time network diagnostic tool.
...
![Mtr Example](../assets/images/mtr-example.png)

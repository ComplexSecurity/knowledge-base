...
Command-line utility used for querying DNS servers and diagnosing DNS problems by displaying the answers returned from specified DNS servers.
...
```bash
$ dig axfr @1.1.1.1 test.com

; <<>> DiG 9.16.1-Ubuntu <<>> axfr @1.1.1.1 test.com
; (1 server found)
;; global options: +cmd
; Transfer failed.
```

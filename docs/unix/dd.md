...
Command-line utility used for low-level copying and conversion of raw data from one file or block device to another.
...
##### Normal a to b copy (default 512 bytes at a time)

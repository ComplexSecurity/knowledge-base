...
Command-line utility used to search for text in files based on patterns and display lines that match those patterns.
...
##### Exact matching amount of chars per lines

...
Command-line utility used to download files from the web, supporting HTTP, HTTPS, and FTP protocols, among others.

## Binary for Windows

- [wget.exe](../assets/files/wget.exe){:download="wget.exe"}

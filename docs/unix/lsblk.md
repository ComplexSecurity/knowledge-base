...
Lists information about all available block devices, showing their relationships and mount points.
...
- [Man7.org](https://man7.org/linux/man-pages/man8/lsblk.8.html)
- [Linux.die.net](https://linux.die.net/man/8/lsblk)

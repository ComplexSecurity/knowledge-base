...
Command-line utility in Windows and Unix-like operating systems used to view and manipulate the IP routing table, allowing for configuration of network routing parameters.
...
##### Dsiplay entire contents of IP routing table
...
##### Display routes in the IP routing table that begin with 10

```powershell
C:\Users\bob>route print 10.*
===========================================================================
Interface List
  9...00 1c 42 b0 90 e2 ......Parallels VirtIO Ethernet Adapter
 14...02 00 4c 4f 4f 50 ......Npcap Loopback Adapter
...
- [Learn.microsoft.com](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/route_ws2008)

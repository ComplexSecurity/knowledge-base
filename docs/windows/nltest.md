...
Command-line utility in Windows used to test and troubleshoot connectivity between domain controllers, as well as to perform various network-related tasks within a Windows domain environment.
...
- [Docs.microsoft.com - Nltest](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/cc731935%28v=ws.11%29)
